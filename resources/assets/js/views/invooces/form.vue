            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" v-model="form.deu_date">
                        <small class="error-control" v-if="errors.deu_date">{{ errors.deu_date[0] }}</small>
                    </div>
                </div>
            </div>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="error-control" v-if="errors.discount">{{ errors.discount[0] }}</small>
                        </td>
                    </tr>
